...
describe('appActionCreators', () => {
  ...
  it('should return a fetch{{PascalCase}}Failure action with error', () => {
  ...
  it('should return a save{{PascalCase}}Failure action with error', () => {
  ...
  it('should return a delete{{PascalCase}}Failure action with error', () => {
